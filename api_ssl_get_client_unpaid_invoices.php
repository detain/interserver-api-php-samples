...
Call Stack:
    ...
    4.2119   21544232   2. Smarty->fetch() /home/detain/myadmin/cpaneldirect/trunk/scripts/api/map_api_to_samples.php:435
    4.2125   21606312   3. include('/home/detain/myadmin/cpaneldirect/trunk/include/rendering/smarty_templates_c/%%CE^CED^CEDF5139%%api_generator_php.tpl.php') /home/detain/myadmin/cpaneldirect/trunk/vendor/Smarty2/libs/Smarty.class.php:1264
    4.2126   21606536   4. implode() /home/detain/myadmin/cpaneldirect/trunk/include/rendering/smarty_templates_c/%%CE^CED^CEDF5139%%api_generator_php.tpl.php:54
...
try {
	...
	$values['sid'] = $sid;
	$response = $client->api_ssl_get_client_unpaid_invoices($values['sid']);
	print_r($response);
	echo "Success\n";
 } catch (Exception $ex) {
