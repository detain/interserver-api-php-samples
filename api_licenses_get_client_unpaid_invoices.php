...
Call Stack:
    ...
    4.1495   21541880   2. Smarty->fetch() /home/detain/myadmin/cpaneldirect/trunk/scripts/api/map_api_to_samples.php:435
    4.1502   21608568   3. include('/home/detain/myadmin/cpaneldirect/trunk/include/rendering/smarty_templates_c/%%CE^CED^CEDF5139%%api_generator_php.tpl.php') /home/detain/myadmin/cpaneldirect/trunk/vendor/Smarty2/libs/Smarty.class.php:1264
    4.1504   21608792   4. implode() /home/detain/myadmin/cpaneldirect/trunk/include/rendering/smarty_templates_c/%%CE^CED^CEDF5139%%api_generator_php.tpl.php:58
...
try {
	...
	$values['sid'] = $sid;
	$response = $client->api_licenses_get_client_unpaid_invoices($values['sid']);
	print_r($response);
	echo "Success\n";
 } catch (Exception $ex) {
