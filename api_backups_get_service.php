...
Call Stack:
    ...
    3.1339   21466400   2. Smarty->fetch() /home/detain/myadmin/cpaneldirect/trunk/scripts/api/map_api_to_samples.php:435
    3.1343   21532832   3. include('/home/detain/myadmin/cpaneldirect/trunk/include/rendering/smarty_templates_c/%%CE^CED^CEDF5139%%api_generator_php.tpl.php') /home/detain/myadmin/cpaneldirect/trunk/vendor/Smarty2/libs/Smarty.class.php:1264
    3.1344   21533056   4. implode() /home/detain/myadmin/cpaneldirect/trunk/include/rendering/smarty_templates_c/%%CE^CED^CEDF5139%%api_generator_php.tpl.php:58
...
try {
	...
	$values['sid'] = $sid;
	$response = $client->api_backups_get_service($values['sid'], $values['id']);
	print_r($response);
	echo "Success\n";
 } catch (Exception $ex) {
